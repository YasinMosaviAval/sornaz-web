...
final class ChatController
{
 ...
 public function file(int$id){try{$f=$this->service->file((int)auth()->id(),$id);return new DownloadResponse($f['path'],$f['name'],$f['mime']);}catch(\Throwable$e){return ResponseFactory::json(['success'=>false,'message'=>$e->getMessage()],404);}}
