        ...
        <ul class="space-y-2">
            ...
            <li>
                ...
                <ul id="scheduleSubmenu" class="mt-1 mr-4 space-y-1 hidden border-r border-indigo-700/60 pr-2">
                    ...
                    <!-- <li><a href="#" onclick="showSection('availabilities-exceptions')"class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 text-sm text-indigo-100"><i class="fas fa-clock w-4"></i> زمان‌های در دسترس و خارج از دسترس</a></li> -->
                </ul>
            </li>
