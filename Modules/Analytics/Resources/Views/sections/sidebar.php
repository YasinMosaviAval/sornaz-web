<div class="w-72 bg-indigo-900 text-white sidebar flex flex-col">
    ...
    <nav class="flex-1 p-4 overflow-y-auto">
        <ul class="space-y-2">
            ...
            <!-- <li>
                <button type="button" onclick="toggleSidebarSubmenu('scheduleSubmenu1', this)" class="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl hover:bg-indigo-800 text-right">
                    <span class="flex items-center gap-3"><i class="fas fa-calendar-alt w-5"></i> پروفایل‌ها</span>
                    <i class="fas fa-chevron-down text-xs transition-transform duration-200 submenu-chevron"></i>
                </button>
                <ul id="scheduleSubmenu1" class="mt-1 mr-4 space-y-1 hidden border-r border-indigo-700/60 pr-2">
                    <li><a href="#" onclick="showSection('profiles')"class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 text-sm text-indigo-100"><i class="fas fa-gavel w-4"></i> کاربران</a></li>
                    <li><a href="#" onclick="showSection('roles')"class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 text-sm text-indigo-100"><i class="fas fa-user-clock w-4"></i> نقش‌ها</a></li>
                    <li><a href="#" onclick="showSection('permissions')"class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 text-sm text-indigo-100"><i class="fas fa-clock w-4"></i> دسترسی‌ها</a></li>
                </ul>
            </li> -->
            ...
            <li>
                ...
                <ul id="scheduleSubmenu" class="mt-1 mr-4 space-y-1 hidden border-r border-indigo-700/60 pr-2">
                    ...
                    <li><a href="#" onclick="showSection('availabilities-exceptions')"class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 text-sm text-indigo-100"><i class="fas fa-clock w-4"></i> مرخصی و ماموریت</a></li>
                </ul>
            </li>
