...
<div id="sidebar" class="fixed inset-y-0 left-0 z-40 w-72 bg-indigo-900 text-white flex flex-col shadow-2xl transform -translate-x-full transition-all duration-300 ease-in-out lg:translate-x-0 lg:static lg:shadow-none">
    ...
    <nav class="flex-1 overflow-y-auto overflow-x-hidden p-4">
        <ul class="space-y-2">
            ...
            <li>
                <button type="button" onclick="toggleSidebarSubmenu('profilesSubmenu', this)" class="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl hover:bg-indigo-800 transition text-right text-yellow-300 hover:text-yellow-200">
                ...
                <ul id="profilesSubmenu" class="mt-1 mr-4 space-y-1 hidden border-r border-indigo-700/60 pr-2">
                    <li><a href="#" onclick="showSection('users')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-yellow-300 hover:text-yellow-200"><i class="fas fa-users w-4"></i>کاربران</a></li>
                    <li><a href="#" onclick="showSection('roles')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-yellow-300 hover:text-yellow-200"><i class="fas fa-user-tag w-4"></i>نقش‌ها</a></li>
                    <li><a href="#" onclick="showSection('permissions')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-yellow-300 hover:text-yellow-200"><i class="fas fa-key w-4"></i>دسترسی‌ها</a></li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <button type="button" onclick="toggleSidebarSubmenu('scheduleSubmenu', this)" class="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl hover:bg-indigo-800 transition text-right text-yellow-300 hover:text-yellow-200">
                ...
                <ul id="scheduleSubmenu" class="mt-1 mr-4 space-y-1 hidden border-r border-indigo-700/60 pr-2">
                    ...
                    <li><a href="#" onclick="showSection('schedules')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-yellow-300 hover:text-yellow-200"><i class="fas fa-chalkboard w-4"></i>برنامه زمانی کلاس‌ها</a></li>
                </ul>
            </li>
