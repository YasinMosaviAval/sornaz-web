<div id="sidebar" class="fixed inset-y-0 left-0 z-40 w-72 bg-indigo-900 text-white flex flex-col shadow-2xl transform -translate-x-full transition-all duration-300 ease-in-out lg:translate-x-0 lg:static lg:shadow-none">
        ...
        <ul class="space-y-2">
            ...
            <li>
                ...
                <ul id="profilesSubmenu" class="mt-1 mr-4 space-y-1 hidden border-r border-indigo-700/60 pr-2">
                    <li><a href="#" onclick="showSection('users')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-indigo-100"><i class="fas fa-users w-4"></i>کاربران</a></li>
                    <li><a href="#" onclick="showSection('roles')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-indigo-100"><i class="fas fa-user-tag w-4"></i>نقش‌ها</a></li>
                    <li><a href="#" onclick="showSection('permissions')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-indigo-100"><i class="fas fa-key w-4"></i>دسترسی‌ها</a></li>
                </ul>
            </li>
            <li>
                <button type="button" onclick="toggleSidebarSubmenu('gallerySubmenu', this)" class="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl hover:bg-indigo-800 transition text-right">
                ...
                <ul id="gallerySubmenu" class="mt-1 mr-4 space-y-1 hidden border-r border-indigo-700/60 pr-2">
                    <li><a href="#" onclick="showSection('gallery-cover')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-indigo-100"><i class="fas fa-image w-4"></i>کاور</a></li>
                    <li><a href="#" onclick="showSection('gallery-logo')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-indigo-100"><i class="fas fa-certificate w-4"></i>لوگو</a></li>
                    <li><a href="#" onclick="showSection('gallery-intro-video')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-indigo-100"><i class="fas fa-video w-4"></i>ویدیو معرفی</a></li>
                    <li><a href="#" onclick="showSection('gallery-collection')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-indigo-100"><i class="fas fa-photo-video w-4"></i>مجموعه عکس‌ها و ویدیوها</a></li>
                </ul>
            </li>
            ...
            <li><a href="#" onclick="showSection('classrooms')" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-indigo-800 transition"><i class="fas fa-door-open w-5 text-center"></i> کلاس‌ها</a></li>
            ...
            <li>
                ...
                <ul id="scheduleSubmenu" class="mt-1 mr-4 space-y-1 hidden border-r border-indigo-700/60 pr-2">
                    <li><a href="#" onclick="showSection('scheduling-rules')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-indigo-100"><i class="fas fa-gavel w-4"></i>قوانین زمانبندی</a></li>
                    ...
                    <li><a href="#" onclick="showSection('schedules')" class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-indigo-800 transition text-sm text-indigo-100"><i class="fas fa-chalkboard w-4"></i>برنامه زمانی کلاس‌ها</a></li>
                </ul>
            </li>
    ...
    <div class="border-t border-indigo-800 p-4">
        <button onclick="location.href='/logout'" class="w-full flex items-center justify-center gap-3 rounded-xl bg-red-600 hover:bg-red-700 py-3 transition">
