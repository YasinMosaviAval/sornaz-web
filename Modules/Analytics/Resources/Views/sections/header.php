<header class="bg-white border-b shadow-sm">
    <div class="flex items-center justify-between px-3 md:px-8 py-4">
        ...
        <div class="flex items-center gap-2 md:gap-6 flex-shrink-0">
            <button onclick="showSection('points')" class="relative p-2">
                <i class="fas fa-coins text-xl md:text-2xl text-gray-600"></i>
            </button>
            <button onclick="showSection('messages')" class="relative p-2">
            ...
            <button onclick="showSection('notifications')" class="relative p-2">
