        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="/analytics/about-us" class="hover:text-white transition">درباره ما</a></li>
                    <li><a href="/analytics/contact-us" class="hover:text-white transition">تماس با ما</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="/analytics/login" class="hover:text-white transition">ورود</a></li>
                    <li><a href="/analytics/register" class="hover:text-white transition">ثبت نام</a></li>
                </ul>
            </div>
        </div>
