...
<section id="tests" class="section hidden">
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <article class="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
            <div class="mb-5"><h2 class="text-xl font-bold">تست ۵: ترم‌ها، جلسات و حضور و غیاب</h2><p class="mt-2 text-sm leading-7 text-gray-500">برای هر دوره بین ۱ تا ۵۰ ترم به همراه جلسات، استادها، هنرجویان، فاکتور، اقساط و حضور و غیاب جلسات برگزارشده ایجاد می‌شود.</p></div>
        ...
        <article class="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
            <div class="mb-5"><h2 class="text-xl font-bold">تست ۴: دوره‌های شعب</h2><p class="mt-2 text-sm leading-7 text-gray-500">برای هر شعبه بین ۱۰ تا ۵۰ دوره واقعی بر اساس درس‌های ارائه‌شده همان شعبه و سطح‌های آموزشی ایجاد می‌شود.</p></div>
