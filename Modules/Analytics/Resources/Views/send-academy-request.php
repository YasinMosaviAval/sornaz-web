    ...
    <div class="max-w-2xl mx-auto px-4 py-12 md:py-16">
        ...
        <form id="academyRegistrationForm" method="POST" action="/academy/send-academy-request" novalidate class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8" onsubmit="return handleAcademyRegistrationSubmit(this)">
            ...
            <div id="academyDetailsStep" class="space-y-5">
                ...
                <div><label class="block text-sm font-medium mb-2">معرفی کوتاه آموزشگاه</label><textarea name="short_description" rows="2" maxlength="500" placeholder="در چند جمله کوتاه، حوزه فعالیت و ویژگی شاخص آموزشگاه را معرفی کنید" class="w-full border border-gray-300 rounded-2xl py-3.5 px-5 focus:outline-none focus:border-indigo-500"><?= e($oldInput['short_description'] ?? '') ?></textarea></div>
