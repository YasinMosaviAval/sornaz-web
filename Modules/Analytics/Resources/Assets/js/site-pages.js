        ...
        : list.map(a => `
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-50 hover:shadow-md transition">
                ...
                <div class="flex gap-2">
                    <a href="/analytics/academy" class="flex-1 border border-indigo-200 text-indigo-600 py-2.5 rounded-xl text-sm hover:bg-indigo-50 text-center block">
                        مشاهده
                    </a>
                    <a href="/analytics/academy-enroll" class="flex-1 bg-indigo-600 text-white py-2.5 rounded-xl text-sm hover:bg-indigo-700 text-center block">
                        ثبت‌نام
                    </a>
                </div>
            </div>
