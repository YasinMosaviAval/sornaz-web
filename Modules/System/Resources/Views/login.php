        ...
        <div class="bg-white rounded-3xl shadow-sm p-8 border border-gray-100">
            <div class="space-y-5">
                ...
                <div class="flex items-center justify-between text-sm">
                    ...
                    <a href="/system/forgot-password" class="text-indigo-600 hover:underline">فراموشی رمز عبور</a>
                </div>
            ...
            <a href="/system/register" class="w-full border border-gray-300 hover:bg-gray-50 py-3.5 rounded-2xl font-medium transition text-center block">ثبت نام</a>
        </div>

        <p class="text-center text-sm text-gray-400 mt-6">
            <a href="/page/home" class="hover:text-indigo-600">بازگشت به صفحه اصلی</a>
        </p>
    </div>
</div>