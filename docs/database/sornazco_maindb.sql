...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2026 at 06:05 AM
...
CREATE TABLE `users` (
  ...
  `register_method` enum('email','phone','google','apple','telegram','sms','admin','import','api') DEFAULT NULL,
...
CREATE TABLE `user_instruments` (
  ...
  `years_of_experience` int(11) UNSIGNED DEFAULT NULL,
