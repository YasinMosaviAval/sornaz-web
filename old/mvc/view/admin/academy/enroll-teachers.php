    ...
    <div class="content">
        ...
        <div class="comments-filter-bar">
            <ul class="filter-list">
                ...
                <li class="filter-item active"><a href="<?=baseUrl() . $settings['academy_managing_panel_topbar_5_sidebar_10']['url'] ?>"><?= translate($settings, 'academy_managing_panel_topbar_5_sidebar_10') ?> <span class="count">(<?//= sizeof($branches_members)?>)</span></a></li>
...
<br>
        ...
        <form method="POST" action="<?=baseUrl()?>/admin/add_new_academy_branch_course_term_enrollment_teacher/">
            ...
            <div class="form-group">
                <label for="member_id">مدرسین</label>
