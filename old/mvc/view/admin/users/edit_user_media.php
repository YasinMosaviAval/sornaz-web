    ...
    <div class="content">
        ...
        <div class="comments-filter-bar">
            <ul class="filter-list">
                ...
                <li class="filter-item active"><a href="<?=baseUrl() . $settings['user_panel_topbar_13_sidebar_1']['url'] ?>"><?= translate($settings, 'user_panel_topbar_13_sidebar_1') ?> <span class="count">(<?//= sizeof($branches_members)?>)</span></a></li>
